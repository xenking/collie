...
class PcmPlayer {
  ...
  append(bytes: ArrayBuffer, sampleRate: number): void {
    ...
    // This source has one lifecycle owner; replacement is intentional.
...
export function VoiceInput({
  ...
  useEffect(() => {
    ...
    // scheduleReconnect reads live refs; re-registering this listener on every render is incorrect.
  ...
  function connect(): Promise<WebSocket> {
    ...
    // This socket has one lifecycle owner; replacement is intentional.
    // eslint-disable-next-line unicorn/prefer-add-event-listener
